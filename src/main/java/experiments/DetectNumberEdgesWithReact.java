...
public class DetectNumberEdgesWithReact {
    static String targetFile = "/your/dir/to/popularRNAppsFromAndroZoo/popularRNAppsFlowDroid.csv";
    static String outFile = "/your/dir/to/popularRNAppsFromAndroZoo/popularRNAppsFlowDroidRN.csv";


    public static void main(String[] args) {

        String appFolder = "/your/dir/to/mostPopularApkFromAndroZoo";
        String outputFolder = "/your/dir/to/popularRNAppsFromAndroZoo/flowdroidRN";
        ...
        for (Object o : sha256Array) {
            ...
            outputFile = outputFolder + "/" + sha256 + ".xml";
